...
export class SupabaseService {
  ...
  // Nuevo método para procesar la sesión tras la redirección del link de confirmación
  async processSessionFromUrl() {
    // La sesión se actualiza automáticamente al abrir el link,
    // aquí simplemente devolvemos la sesión actual
    return await this.supabase.auth.getSession();
  }
